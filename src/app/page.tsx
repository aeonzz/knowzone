          ...
          <div className="flex items-center justify-center space-x-28">
            ...
            <div className="space-y-5">
              ...
              <p className="font-semibold text-[#3E3D3D]">
                ...
                of your research. Find the resources you need swiftly, and
                unlock a world of discoveries with every search.
              </p>
            </div>
          </div>
        </section>
        <section className="container w-full px-32 pb-20" id="about">
          <div className="flex flex-col items-center justify-center space-y-20">
            ...
            <div className="space-y-5">
              ...
              <div className="mr-7 flex w-[400px] flex-wrap gap-5">
